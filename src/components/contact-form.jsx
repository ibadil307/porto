...
export const CloseButton = styled.div`
  ...
  hover:opacity-100 hover:cursor-pointer before:bg-stone-800 after:bg-stone-800`}
  &:before, &:after {
    position: absolute;
    left: 15px;
    content: ' ';
...
export const FormInput = tw.input`
  border-2 border-stone-800 rounded-xl py-4 px-5 bg-transparent
  text-xl font-thin outline-none`;

export const FormLabel = tw.label`text-stone-800 font-thin text-sm pb-1 mt-8`;

export const FormText = tw.textarea`
  border-2 border-stone-800 rounded-xl py-4 px-5 
...
export const SubmitButton = tw.input`
  ...
  border-stone-800 rounded-xl hover:opacity-50 duration-300 
